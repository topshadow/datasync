...
namespace WebApplication1.Dtos
{
    ...
    /// 查询某日期随访记录是否存在
    /// </summary>
    public class SaveRepairPlanInput : UserBaseToken
    {
    ...
    /// 查询全年的随访记录
    /// </summary>
    public class GetCurYearVisitPlanInput : UserBaseToken
    {
        /// <summary>
        /// 服务
        /// </summary>
    ...
    /// 获取随访记录详情
    /// </summary>
    public class GetVisitInfoInput : UserBaseToken
    {
        /// <summary>
    ...
    public class GetVisitInfoResultVisitInfo
    {
        ...
        /// <summary>
        /// 症状  
        /// key 0 无症状 1 头痛头晕, 2 恶心呕吐3.眼花耳鸣4.呼吸困难5.心悸胸闷6.鼻衄出血不止7.四肢发麻8.下肢水肿 10.其他 
        /// 示例 结果 
    ...
    /// 自动同步随访记录
    /// </summary>
    public class AutoAddVisitRecordInput : UserBaseToken
    {
        /// <summary>
        /// 用户的身份证号
        /// </summary>
